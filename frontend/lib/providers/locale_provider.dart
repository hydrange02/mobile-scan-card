...
class LocaleProvider extends ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'current_pin': 'Current PIN (4-6 digits)',
      ...
      'pin_required': 'PIN code is required (4-6 digits)',
    ...
    'vi': {
      ...
      'current_pin': 'Mã PIN hiện tại (4-6 chữ số)',
      'new_pin': 'Mã PIN mới (4-6 chữ số)',
      ...
      'pin_required': 'Vui lòng nhập Mã PIN (từ 4-6 chữ số)',
